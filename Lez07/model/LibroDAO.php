...
class LibroDAO {
    ...
    public function getLibri(){
        ...
        //$res->setFetchMode(PDO::FETCH_OBJ,"Libro");
    ...
    $statement = $this->conn->prepare("Insert into libri(titolo,pagine,prezzo,autore) values(:titolo,:pagine,:prezzo,:autore)");

$statement->bindParam(":titolo",$libro->titolo,PDO::PARAM_STR);
$statement->bindParam(":pagine",$libro->pagine,PDO::PARAM_INT);
$statement->bindParam(":prezzo",$libro->prezzo,PDO::PARAM_INT);
